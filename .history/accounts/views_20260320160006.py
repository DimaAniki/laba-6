...
from rest_framework.decorators import api_view, permission_classes  # ← Важно!
...
@api_view(['GET'])
@permission_classes([AllowAny])  # ← Теперь работает!
...
class RegisterView(generics.CreateAPIView):
    ...
    permission_classes = [permissions.AllowAny]  # ← Для классов это атрибут, не декоратор
